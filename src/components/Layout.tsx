  ...
  return (
    <div className="flex h-[100dvh] w-full bg-background text-foreground transition-colors duration-300 pt-[env(safe-area-inset-top)]">
      ...
      <main className="flex-1 w-full overflow-y-auto relative flex flex-col">
        {/* Mobile Top Header */}
        <div className="md:hidden flex items-center justify-between px-3 py-3 min-h-[72px] bg-card border-b border-border sticky top-0 z-40 relative overflow-hidden">
          <img src="https://i.ibb.co/VYyZWwpp/Untitled-project-Photoroom.png" alt="Guruba Logo" className="h-8 sm:h-10 object-contain relative z-10 shrink-0" />
          
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-0 flex items-center justify-center pointer-events-none">
            <img src="https://i.ibb.co/Pv139k1Y/Untitled-project-Photoroom.png" alt="Guruba Text" className="h-[52px] sm:h-[64px] w-auto object-contain" />
          </div>

          <button 
            onClick={() => setMobileMenuOpen(true)}
            className="p-2 hover:bg-card-foreground/5 rounded-full active:scale-95 transition-transform min-w-[44px] min-h-[44px] flex items-center justify-center relative z-10 shrink-0"
          >
